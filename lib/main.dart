...
Future<void> main() async {
  ...
  // Remove the line that sets enableDithering

  if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
    await Hive.initFlutter('EchoPlay');
  } else {
...
Future<void> startService() async {
  final AudioPlayerHandler audioHandler = await AudioService.init(
    ...
    config: AudioServiceConfig(
      androidNotificationChannelId: 'com.rockstarpabitra.echoplay.channel.audio',
      androidNotificationChannelName: 'EchoPlay',
...
Future<void> openHiveBox(String boxName, {bool limit = false}) async {
  final box = await Hive.openBox(boxName).onError((error, stackTrace) async {
    ...
    if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      dbFile = File('$dirPath/EchoPlay/$boxName.hive');
      lockFile = File('$dirPath/EchoPlay/$boxName.lock');
    }
    await dbFile.delete();
