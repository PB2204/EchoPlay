...
import '/Screens/Home/saavn.dart' as home_screen;
import '/Screens/Settings/player_gradient.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/EchoPlay/Backups',
  ) as String;
                        ...
                        ListTile(
                          ...
                          trailing: TextButton(
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                        dirName: 'EchoPlay/Backups',
                                      ) ??
                                      '/storage/emulated/0/EchoPlay/Backups';
                              Hive.box('settings')
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Share.share(
                              '${AppLocalizations.of(
                                context,
                              )!.shareAppText}: https://github.com/PB2204/EchoPlay',
                            );
                          },
                          dense: true,
                        ),
                        ListTile(
                          ...
                          onTap: () {
                            launchUrl(
                              Uri.parse(
                                'https://buymeacoffee.com/rockstarpabitra',
                              ),
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            const String upiUrl =
                                'https://facebook.com/Journalist.Pabitra.Banerjee';
                            launchUrl(
                              Uri.parse(upiUrl),
                              mode: LaunchMode.externalApplication,
                            );
                          ...
                          onLongPress: () {
                            copyToClipboard(
                              context: context,
                              text: 'https://facebook.com/Journalist.Pabitra.Banerjee',
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Drockstarpabitra2204%40gmail.com%26subject%3DRegarding%2520Mobile%2520App',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'https://instagram.com/coderpabitra',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
